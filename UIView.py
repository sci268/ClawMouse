...
class Ui_UIView(object):
    def setupUi(self, UIView):
        ...
        UIView.setMinimumSize(QSize(920, 720))
        icon = QIcon()
        ...
        self.label_brand_icon = QLabel(self.brandPanel)
        self.label_brand_icon.setObjectName(u"label_brand_icon")
        self.label_brand_icon.setGeometry(QRect(780, 16, 92, 86))
        self.label_brand_icon.setPixmap(QPixmap(u":/pic/Mondrian.png"))
        self.label_brand_icon.setScaledContents(True)
        self.label_brand_subtitle = QLabel(self.brandPanel)
        self.label_brand_subtitle.setObjectName(u"label_brand_subtitle")
        self.label_brand_subtitle.setGeometry(QRect(20, 56, 620, 24))
        font1 = QFont()
        ...
        self.label_brand_flow.setGeometry(QRect(20, 84, 740, 22))
